...
plot(new_data$date_time,new_data$Voltage, type="l",ylab="voltage", xlab="datetime")

plot(new_data$date_time,new_data$Global_reactive_power, type="l",ylab="Global reactive Power (kilowatts", xlab="datetime")
